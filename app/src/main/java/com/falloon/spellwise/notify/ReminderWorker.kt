...
import com.falloon.spellwise.MainActivity
import com.falloon.spellwise.R
import com.falloon.spellwise.SpellwiseApp
...
class ReminderWorker(
    ...
    override suspend fun doWork(): Result {
        val app = applicationContext as SpellwiseApp
